                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td><a href=" " data-toggle="modal" data-target="#changePassword"
                                       style="font-size: 18px; color: #F5B041" v-b-tooltip.focus
  title="change Password">change password</a></td>
  ...
  title="edit profile"></i>
            ...
            <div class="col-8">
                ...
                @foreach($requestQuestion as $post)
                    <div v-if="post.requestDoctor.role == 'doctor' && post.requestDoctor.id == doctor.user.id">
                                ...
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-2 text-right"
                                            ...
                                            <b-button class="btn btn-warning" type="submit">answer</b-button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           ...
                                           oninput="setCustomValidity('')" required>
                                    <div v-if="(errors.has('phone_number'))">
