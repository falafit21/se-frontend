    ...
    <div class="container" style="margin-top: 20px; color:dimgrey;">
        ...
        <div class="tab-content" style="background-color: white;">
            <div id="home" class="container tab-pane active"><br>
                <!-- {{--                <div class="container">--}} -->
                <div class="card-body"
                     style="color: black; margin-top: 10px; margin-right: 250px; margin-left: 250px; margin-bottom: 50px;">
                    ...
                    <form method="post" action="{{ route('petTip.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('detail') is-invalid @enderror" id="detail" rows="3"
            ...
            <div id="menu1" class="container tab-pane fade"><br>
                <div class="card-body" style="color: black; margin-top: 10px; margin-right: 250px; margin-left: 250px; margin-bottom: 50px;">
                    <h4 style="">Create Tip</h4>
                            ...
                            <form id="deleteForm" onsubmit="return confirm('Are you sure to delete this post?')"
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <button class="far fa-edit"
                                            ...
                                            type="button" data-id="{{$tip->id}}" data-toggle="modal"
                                            data-target="#edit-{{ $tip->id }}" data-placement="top"
                                            title="edit comment">

                                    </button>
                                    <button class="fas fa-trash-alt" type="submit"
                                            style="background-color: Transparent;border:none; color: #E74C3C; font-size: 20px"
                                             data-toggle="tooltip" data-placement="top" title="delete tip">
                                    </button>
                        ...
                        <div class="row">
                            ...
                            <form id="deleteForm" onsubmit="return confirm('Are you sure to delete this post?')"
                                ...
                                <div class="row" style="margin-top: 10px;padding-left: 40px">
                                    <b-button class="fas fa-trash-alt" type="submit"
                                            style="background-color: Transparent;border:none; color: #E74C3C; font-size: 20px"
                                           data-toggle="tooltip" data-placement="top" title="delete tip">
                                    </b-button>
        ...
        @foreach($tips as $tip)
            <div class="modal fade" id="edit-{{ $tip->id }}" tabindex="-1" role="dialog"
                        ...
                        <form action="{{ route('petTip.update',['petTip'=>$tip->id])}}" method="post">
                            ...
                            <div class="modal-body">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="title"
                                                   ...
                                                   placeholder="Enter title" value="{{tip.title}}"
                                    ...
                                    <tr>
                                        <th>Detail</th>
                                        <td><v-textarea type="text"
                                                      class="form-control {{ errors.has('detail') ? ' has-error' : '' }}"
                                                      id="detail" name="detail" aria-describedby="emailHelp"
                                                      placeholder="Tips Detail"
                            ...
                            <div class="modal-footer">
                                <b-button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</b-button>
