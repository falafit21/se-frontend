            ...
            <form action="{{  route('post.comment.store', ['post_id' => $post->id]) }}" style="margin-top: 30px;"
                ...
                <div class="row">
                    <div class="col-10">
                        ...
                        <v-textarea name="answer" id="answer" style="width: 100%" rows="3"
                                  class="form-control error('answer') is-invalid enderror">{{ old('answer') }}</v-textarea>
                        @error('answer')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <v-textarea type="text"
                                          ...
                                          required>{{ post.detail }}</v-textarea>
